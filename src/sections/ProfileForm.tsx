...
export const ProfileForm = ({ onSubmit }: ProfileFormProps) => {
  ...
  const renderStep = () => {
    // New question flow to reflect a pro-DPI stance
    switch (currentStep) {
      case 1:
        return (
          <div>
      ...
      case 9:
        return (
          <div>
            ...
            <div className="space-y-3">
              {['Term Life', 'Whole Life', 'Integrated Life Plan'].map((type) => (
  ...
  const isStepComplete = () => {
    // Updated stepFields array to match the new order
    const stepFields = ['name', 'age', 'healthConditions', 'smokingStatus', 'dependents', 'occupation', 'annualIncome', 'involvementLevel', 'insuranceType'];
